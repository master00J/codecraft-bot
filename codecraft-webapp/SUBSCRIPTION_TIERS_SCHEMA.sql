-- Subscription Tiers Management Schema
...
CREATE TABLE IF NOT EXISTS subscription_tiers (
    ...
    display_name TEXT NOT NULL, -- 'Free', 'Basic', 'Premium', 'Enterprise'
    description TEXT,
    ...
    features JSONB DEFAULT '{}', -- Flexible features storage
    limits JSONB DEFAULT '{}', -- Flexible limits storage
...
CREATE TABLE IF NOT EXISTS tier_features (
    ...
    feature_key TEXT NOT NULL, -- 'leveling', 'moderation_advanced', etc.
    feature_name TEXT NOT NULL, -- 'Advanced Leveling System'
    feature_description TEXT,
    enabled BOOLEAN DEFAULT true,
    limit_value INTEGER, -- NULL = unlimited, 0 = disabled, >0 = limit
    created_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS feature_definitions (
    ...
    is_boolean BOOLEAN DEFAULT true, -- true = on/off, false = has limit value
...
VALUES 
    ('free', 'Free', 'Perfect for small communities getting started', 0.00, 0.00, 1, 
     '{"leveling": true, "moderation_basic": true, "welcome": false, "analytics": false, "custom_branding": false}',
     '{"custom_commands": 5, "stream_notifications": 1, "xp_boost": 1.0}'),
    
    ('basic', 'Basic', 'Great for growing communities', 4.99, 49.90, 2,
     '{"leveling": true, "moderation_advanced": true, "welcome": true, "analytics": true, "custom_branding": false}',
     '{"custom_commands": 25, "stream_notifications": 5, "xp_boost": 1.2}'),
    
    ('premium', 'Premium', 'Most popular for active communities', 9.99, 99.90, 3,
     '{"leveling": true, "moderation_advanced": true, "welcome": true, "analytics": true, "custom_branding": true}',
     '{"custom_commands": -1, "stream_notifications": -1, "xp_boost": 1.5}'),
    
    ('enterprise', 'Enterprise', 'Full power for large communities', 29.99, 299.90, 4,
     '{"leveling": true, "moderation_advanced": true, "welcome": true, "analytics": true, "custom_branding": true, "api_access": true, "multi_guild": true}',
     '{"custom_commands": -1, "stream_notifications": -1, "xp_boost": 2.0, "max_guilds": 5}')
...
-- Public can read tiers (for pricing page)
