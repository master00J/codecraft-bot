...
CREATE TABLE IF NOT EXISTS embed_images (
  ...
  url TEXT NOT NULL, -- CDN URL (e.g. Supabase Storage, Imgur, etc.)
  size_bytes INTEGER,
  mime_type TEXT,
...
CREATE TABLE IF NOT EXISTS embed_templates (
  ...
  -- Template structure (same as saved_embeds)
  title TEXT,
  description TEXT,
  color TEXT,
  fields JSONB DEFAULT '[]'::jsonb,
...
INSERT INTO embed_templates (name, description, category, title, description, color, fields) VALUES
(
  'Server Rules',
...
(
  ...
  'welcome',
  '👋 Welcome!',
  'Thanks for joining our community! We''re glad to have you here.',
  '#5865F2',
  '[
