...
export function ChatWidget() {
  ...
  return (
    <>
      {/* Chat Widget */}
      {isOpen && (
        <div className={`fixed bottom-20 right-6 w-96 max-w-[calc(100vw-3rem)] bg-background border rounded-lg shadow-2xl z-50 flex flex-col transition-all overflow-hidden ${
          ...
          {!isMinimized && (
            <>
              {isInDashboard ? (
                <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'support' | 'ai')} className="flex-1 flex flex-col min-h-0">
                  ...
                  <TabsContent value="support" className="flex-1 flex flex-col m-0 overflow-hidden min-h-0 data-[state=active]:flex data-[state=inactive]:hidden">
                  ...
                  <TabsContent value="ai" className="flex-1 flex flex-col m-0 overflow-hidden min-h-0 data-[state=active]:flex data-[state=inactive]:hidden">
                    {/* AI Messages */}
                    <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-4 bg-muted/20">
                      {aiMessages.map((msg) => (
                        <div
