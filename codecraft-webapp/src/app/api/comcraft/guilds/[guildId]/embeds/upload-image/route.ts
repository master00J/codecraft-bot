/**
 * API Route: Upload Image for Embeds
 * /api/comcraft/guilds/[guildId]/embeds/upload-image
 * 
 * Uses Supabase Storage for reliable image hosting
 */
...
export async function POST(
  ...
  try {
    ...
    // Save to embed_images table for tracking
