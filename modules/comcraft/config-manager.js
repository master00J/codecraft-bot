...
class ConfigManager {
  ...
  async getSubscriptionLimits(guildId) {
    ...
    if (license) {
      ...
      const fallback = {
        free: { custom_commands: 5, stream_notifications: 1, twitter_monitors: 0, xp_boost: 1.0, ai_tokens_monthly: 50000 },
        basic: { custom_commands: 25, stream_notifications: 5, twitter_monitors: 2, xp_boost: 1.2, ai_tokens_monthly: 250000 },
        premium: { custom_commands: -1, stream_notifications: -1, twitter_monitors: 5, xp_boost: 1.5, ai_tokens_monthly: 1000000 },
        enterprise: { custom_commands: -1, stream_notifications: -1, twitter_monitors: -1, xp_boost: 2.0, ai_tokens_monthly: -1 }
      };
    ...
    if (config.is_trial && config.trial_ends_at) {
      ...
      if (now < trialEnd) {
        ...
        return { custom_commands: -1, stream_notifications: -1, twitter_monitors: -1, xp_boost: 2.0, ai_tokens_monthly: -1, multi_guild: 5 };
      }
    }
